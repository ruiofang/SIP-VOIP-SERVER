...
#   RTP_STICKY_MODE=false RTP_STICKY_PORT=20000
...
RTP_STICKY_MODE="${RTP_STICKY_MODE:-false}"
RTP_STICKY_PORT="${RTP_STICKY_PORT:-$RTP_MIN}"
...
RTP_STICKY_MODE=$RTP_STICKY_MODE
RTP_STICKY_PORT=$RTP_STICKY_PORT
